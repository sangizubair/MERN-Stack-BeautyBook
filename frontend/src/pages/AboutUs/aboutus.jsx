...
const AboutUs = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row ">
      {/* Sidebar */}
      <div className="w-full lg:w-1/4 min-h-fit flex flex-col justify-between py-8 px-8 border-r border-gray-300">
...
const SidebarTab = ({ label, tab, activeTab, onClick }) => (
  <button
    className={`text-gray-600 hover:text-btnColor font-bold py-2 px-4 text-left focus:outline-none ${activeTab === tab ? 'text-blue-600' : ''
