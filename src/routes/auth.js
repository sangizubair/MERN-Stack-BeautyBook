...
import { registerUser , loginUser , registerSalon , loginSalon , bookSalonService  , deleteBooking , updateBookingStatus , getSalonBookings } from '../controllers/authController.js';
...
router.delete('/deletebooking/:bookingId', deleteBooking); // for user only 
